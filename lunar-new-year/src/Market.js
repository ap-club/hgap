class Market extends Phaser.Scene {
  ...
  create() {
    ...
    /* Scene boilerplate */
    this.bg = this.add.image(0, 0, 'market');
    this.bg.depth = 0;
  ...
  play() {
    ...
    const foreground = this.add.image(0, 0, 'pillar');
    foreground.scale = this.bg.scale * (2237 / 1536) * 0.73242;
    foreground.depth = 20;
    foreground.setX(foreground.displayWidth / 2);
    foreground.setY(foreground.displayHeight / 2);

    const ingredientIndices = [3, 4];
    const ingredientPositionRatios = [1142 / 1920, 1653 / 1920];
